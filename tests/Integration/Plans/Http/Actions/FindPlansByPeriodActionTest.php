...
final class FindPlansByPeriodActionTest extends BaseTestCase
{
    ...
    /**
        ...
        @dataProvider dates
     */
    public function that_creates_plan(array $dates, array $duration, int $expectedCount)
    {
        ...
        $request = $this->createRequest("GET", "v1/plans/by/period?startDate={$duration[0]}&endDate={$duration[1]}");
    ...
    public function dates()
    {
        return [
            [
                ...
                ["2020-01-01 15:41:13", "2020-02-02 15:41:13"], 1
            ],
            [
                [["2020-02-05 00:00:00", "2020-02-12 23:59:59",],
                ["2020-02-01 00:00:00", "2020-02-01 23:59:59",],
                ["2020-02-01 00:00:00", "2020-02-08 23:59:59",]],
                ["2020-02-02 13:41:13", "2020-02-28 21:24:12"], 2
            ],
        ];
    }
}
